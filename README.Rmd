...
```
[![Travis build status](https://travis-ci.org/INWTlab/config.svg?branch=master)](https://travis-ci.org/INWTlab/config)
[![Coverage status](https://codecov.io/gh/INWTlab/config/branch/master/graph/badge.svg)](https://codecov.io/github/INWTlab/config?branch=master)
